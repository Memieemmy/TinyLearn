...
export function ArticleCard({ id, image, category, title, description, author, date }) {
  ...
  return (
    <div className="rounded-2xl overflow-hidden cursor-pointer" onClick={() => navigate(`/post/${id}`)}>
